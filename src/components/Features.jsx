...
import { FaMapMarkerAlt, FaHeart, FaFirstAid, FaClipboardList } from 'react-icons/fa';
import './Features.css';
  ...
  const originalFeatures = [
    {
      icon: <FaMapMarkerAlt />,
      title: 'NearBy',
      description: 'You will be able to find nearby police stations and nearby women safety NGO.',
      color: '#ff69b4',
    },
    {
      icon: <FaHeart />,
